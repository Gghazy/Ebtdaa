...
namespace Ebtdaa.Persistence.Migrations
{
    ...
    [Migration("20231231040917_Intial_Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ebtdaa.Domain.Factories.Entity.Factory", b =>
                {
                    ...
                    b.Property<int?>("FactoryContactId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FactoryContactId")
                        .IsUnique()
                        .HasFilter("[FactoryContactId] IS NOT NULL");

                    b.HasIndex("FactoryFinancialId")
                        .IsUnique()
                        .HasFilter("[FactoryFinancialId] IS NOT NULL");

                    b.HasIndex("FactoryLocationId")
                        .IsUnique()
                        .HasFilter("[FactoryLocationId] IS NOT NULL");
            ...
            modelBuilder.Entity("Ebtdaa.Domain.Factories.Entity.Factory", b =>
                {
                    b.HasOne("Ebtdaa.Domain.Factories.Entity.FactoryContact", "FactoryContact")
                        .WithOne("Factory")
                        .HasForeignKey("Ebtdaa.Domain.Factories.Entity.Factory", "FactoryContactId");

                    b.HasOne("Ebtdaa.Domain.Factories.Entity.FactoryFinancial", "FactoryFinancial")
                        .WithOne("Factory")
                        .HasForeignKey("Ebtdaa.Domain.Factories.Entity.Factory", "FactoryFinancialId");

                    b.HasOne("Ebtdaa.Domain.Factories.Entity.FactoryLocation", "FactoryLocation")
                        .WithOne("Factory")
                        .HasForeignKey("Ebtdaa.Domain.Factories.Entity.Factory", "FactoryLocationId");

                    b.Navigation("FactoryContact");
